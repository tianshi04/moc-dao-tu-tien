  ...
  useEffect(() => {
    const fetchPlants = async () => {
      try {
        ...
        toast.error('Không thể tải danh sách chậu cây')
      } finally {
        setLoading(false)
      }
    }
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>
              {plants.length > 0 ? `Bạn đang chăm sóc ${plants.length} chậu cây` : 'Bạn chưa liên kết chậu cây nào'}
            </p>
          </div>
          <div>
            <button
                ...
                <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <span style={{
                      ...
                      {plant.plant_type || 'Không rõ loài'}
                    </span>
                  </div>
                </div>
